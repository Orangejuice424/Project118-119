...
document.getElementById("Drawn").innerHTML="sketch to be drawn is " + sketch
...
function setup(){
 ...
 function draw(){
    ...
    function gotResult(error, results){
        ...
        document.getElementById("Sketching").innerHTML="your sketch: " + drawn_sketch
 ...
 function check_sketch(){
    timer_counter++
    document.getElementById("Timing").innerHTML="Timer : " + timer_counter
